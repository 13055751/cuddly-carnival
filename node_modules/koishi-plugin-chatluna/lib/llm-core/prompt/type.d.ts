...
export interface RawPreset {
    ...
    world_lores?: ({
        ...
        insertPosition?: 'before_char_defs' | 'after_char_defs' | 'before_scenario' | 'after_scenario' | 'before_example_messages' | 'after_example_messages';
    } | {
...
export interface RoleBook {
    ...
    constant?: boolean;
    order?: number;
    insertPosition?: 'before_char_defs' | 'after_char_defs' | 'before_example_messages' | 'after_example_messages';
}
...
export declare function isRoleBook(obj: unknown): obj is RoleBook;
export declare function isRoleBookConfig(obj: unknown): obj is RoleBookConfig;
