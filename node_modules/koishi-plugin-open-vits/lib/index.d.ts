...
import { AudioMime, Lang, SpeakerList, T4wefanText, VitsEngine } from './types';
...
declare class OpenVits extends Vits {
    ...
    handleSay(session: Session<'vits_engine' | 'vits_speakerId'>, options: {
        lang?: string;
        speaker?: number;
    }, input: string): Promise<string | h>;
    /**
     *
     * @param input 要转化的文本
     * @returns
     ...
     * @returns
     */
    baseSay(option: OpenVits.Result, engine: VitsEngine, optionLang: Lang): Promise<h>;
}
