 ...
 */
export declare class LunaDBVectorStore extends SaveableVectorStore {
    client: LunaDB;
    docstore: SynchronousInMemoryDocstore;
    getDocstore(): SynchronousInMemoryDocstore;
    _vectorstoreType(): string;
    constructor(client: LunaDB, embeddings: EmbeddingsInterface, args?: LunaVDBLibArgs);
    /**
     ...
     */
    static load(directory: string, embeddings: EmbeddingsInterface): Promise<LunaDBVectorStore>;
    /**
     ...
     */
    static fromTexts(texts: string[], metadatas: object[] | object, embeddings: EmbeddingsInterface, client: LunaDB, options?: LunaVDBLibArgs): Promise<LunaDBVectorStore>;
    /**
     ...
     * @returns A promise that resolves with a new `VoyVectorStore` instance.
     */
    static fromDocuments(docs: Document[], embeddings: EmbeddingsInterface, client: LunaDB, options?: LunaVDBLibArgs): Promise<LunaDBVectorStore>;
}
